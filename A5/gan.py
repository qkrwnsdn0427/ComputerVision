...
def discriminator_loss(logits_real, logits_fake):
    ...
    loss1=nn.BCEWithLogitsLoss(reduction='mean')(logits_real, real)
    loss2=nn.BCEWithLogitsLoss(reduction='mean')(logits_fake, fake)
    loss=loss1+loss2
    ##############################################################################
    #                              END OF YOUR CODE                              #
    ##############################################################################
...
def generator_loss(logits_fake):
    ...
    loss=nn.BCEWithLogitsLoss(reduction='mean')(logits_fake,fake)
    ##############################################################################
    #                              END OF YOUR CODE                              #
    ##############################################################################
    return loss
...
def ls_discriminator_loss(scores_real, scores_fake):
    ...
    # Replace "pass" statement with your code
    N=len(scores_real)
    loss1=(scores_fake).pow(2).sum()/N 
    loss2=(scores_real-1).pow(2).sum()/N
